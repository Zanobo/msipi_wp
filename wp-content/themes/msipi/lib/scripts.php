...
function roots_scripts() {
  ...
  wp_enqueue_style('roots_main', get_template_directory_uri() . '/style.css', false, '001');
	wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.css', false, '001');
  ...
  wp_register_script('roots_scripts', get_template_directory_uri() . '/assets/js/main.js', false, '001', true);
